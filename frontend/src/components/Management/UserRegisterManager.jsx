...
function UserRegisterManager({ accessToken, accentColor = "#64748b" }) {
        ...
        <div className="p-4 md:p-5">
          ...
          <div className="overflow-x-auto">
            <table className="w-full text-xs border-separate border-spacing-0">
              ...
              <tbody>
                {list.map((u) => (
                  <tr key={cfg.getRowId(u)} className="hover:bg-slate-50 transition">
                    <td className="py-2 px-2 border-b border-slate-100">{cfg.getMainId(u)}</td>
